...
const wizardStepsContent: {
  ...
  },
  {
    ...
    options: [
      ...
      { name: "Ronaldo", label: "ron" },
      { name: "Like and respect both", label: "ajsdkads" },
      { name: "Dislike both", label: "dasjdksad" },
      { name: "Don't care", label: "asdasadsdas" },
    ],
    type: "radio",
    textSize: "text-lg",
  },
  ...
  },
  {
    ...
    options: [
      ...
      { name: "Enjoyable", label: "enj" },
      { name: "No idea", label: "idk" },
    ],
    type: "radio",
    textSize: "text-2xl",
  },
